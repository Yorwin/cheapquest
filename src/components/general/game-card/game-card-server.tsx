...
const GameStandardContainer = ({ title, discount, oldPrice, currentPrice, webOffer, classes = defaultClasses, children }: GameStandardControllerType) => {
            ...
            <div className={styles[classes.priceOfferOriginContainer]}>
                <div className={styles["content-container"]}>
                    <div className={styles["offer-container"]}>
                        <p className={styles[classes.discount]}>{discount}</p>
